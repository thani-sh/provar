...
We will define tests using a visual **graph structure** stored in `<name>.spec.yml` files. This allows for clear visualization of paths, reusable nodes, and complex branching.
