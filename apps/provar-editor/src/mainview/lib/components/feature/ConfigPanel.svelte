...
>
	...
	<div class="flex-1 space-y-8 overflow-y-auto p-6">
		<section>
			<h3 class="mb-4 text-xs font-medium tracking-wider text-zinc-500 uppercase">
				AI Configuration
			</h3>
		...
		<section>
			<div class="mb-4 flex items-center justify-between">
				<h3 class="text-xs font-medium tracking-wider text-zinc-500 uppercase">Variables</h3>
			</div>
			...
			<div class="space-y-3">
				<div class="relative">
					...
					{#if jsonError}
						<div class="mt-2 font-mono text-[10px] leading-tight text-red-400/80">
							{jsonError}
						</div>
					{/if}
				</div>
