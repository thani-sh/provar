---
name: maintenance
description: Describes how to maintain the codebase.
---

## Purpose
Analyze a codebase to identify architectural flaws, technical debt, and violations of clean coding practices, then design a structured, low-risk refactoring strategy.

## Context & Objectives
When reviewing source code, prioritize enterprise software engineering principles over quick fixes. Focus on transforming rigid, tightly coupled, and bloated implementations into highly modular, testable, and scalable systems using standard design patterns and clean code metrics.
...
Every code review execution must produce a structured response covering the following five sections:
